...
// 1. Write test implementing the diamond [meaning you deploy the diamond importing the function from the deploy script and then create a certificate using certificateFactory then test the case]
// 2. 